...
public class ValuesOnceAsyncEmitter<T extends FirebaseModel> implements Action1<AsyncEmitter<T>> {

    private final Query query;
    private final Class<T> type;

    public ValuesOnceAsyncEmitter(@NonNull Query query, @NonNull Class<T> type) {
        this.type = type;
        this.query = query;
    }
    ...
    private static class RxValuesEventListener<T extends FirebaseModel> implements ValueEventListener {
        ...
        RxValuesEventListener(@NonNull AsyncEmitter<T> asyncEmitter,
