 ...
 */
public class CompensationConfirmAmountDialogFragment extends BaseDialogFragment<CompensationConfirmAmountDialogFragment.DialogInteractionListener> {

    private static final String DIALOG_TAG = CompensationConfirmAmountDialogFragment.class.getCanonicalName();
    ...
    /**
     * Shows a new instance of {@link CompensationConfirmAmountDialogFragment}.
     *
    ...
    public static void display(@NonNull FragmentManager fragmentManager,
        ...
        final CompensationConfirmAmountDialogFragment dialog =
                CompensationConfirmAmountDialogFragment.newInstance(amount, debtorNickname, currency);
        dialog.show(fragmentManager, DIALOG_TAG);
    }

    @NonNull
    private static CompensationConfirmAmountDialogFragment newInstance(@NonNull BigFraction amount,
                                                                       @NonNull String nickname,
                                                                       @NonNull String currency) {
        CompensationConfirmAmountDialogFragment fragment = new CompensationConfirmAmountDialogFragment();
