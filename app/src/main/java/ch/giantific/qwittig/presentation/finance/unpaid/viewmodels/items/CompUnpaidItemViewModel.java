...
package ch.giantific.qwittig.presentation.finance.unpaid.viewmodels.items;
 ...
 */
public class CompUnpaidItemViewModel extends BaseChildItemViewModel
        implements Comparable<CompUnpaidItemViewModel> {
    ...
    public CompUnpaidItemViewModel(@EventType int eventType,
    ...
    @Override
    public int compareTo(@NonNull CompUnpaidItemViewModel itemViewModel) {
        if (credit && !itemViewModel.isCredit()) {
            return 1;
        }

        return amountFraction.compareTo(itemViewModel.getAmountFraction());
    }
    ...
    public boolean equals(Object o) {
        ...
        final CompUnpaidItemViewModel that = (CompUnpaidItemViewModel) o;
