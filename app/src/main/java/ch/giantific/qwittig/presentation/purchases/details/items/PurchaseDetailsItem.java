...
/**
 * Provides an implementation of the {@link PurchaseDetailsBaseItem} for a purchase item.
 */
public class PurchaseDetailsItem extends BaseObservable implements PurchaseDetailsBaseItem {
