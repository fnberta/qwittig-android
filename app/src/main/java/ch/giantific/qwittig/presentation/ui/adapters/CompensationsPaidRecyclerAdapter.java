...
import ch.giantific.qwittig.presentation.viewmodels.rows.CompPaidRowViewModel;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        switch (viewType) {
            case FinanceCompsPaidViewModel.TYPE_ITEM:
                ...
                if (viewModel == null) {
                    viewModel = new CompPaidRowViewModel(compensation, mViewModel.getCurrentUser());
