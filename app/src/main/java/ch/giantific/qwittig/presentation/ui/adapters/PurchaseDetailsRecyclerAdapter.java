...
public class PurchaseDetailsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            ...
            case Type.USERS_INVOLVED: {
                ...
                row.setUsers(detailsItem.getUsersInvolved());
                break;
            }
        }
    }
    ...
    private static class UsersRow extends BindingRow<RowPurchaseDetailsUsersBinding> {
        ...
        public UsersRow(@NonNull Context context,
            ...
            mRecyclerAdapter = new PurchaseDetailsUsersRecyclerAdapter(viewModel, mUsers);
        ...
        public void setUsers(@NonNull List<ParseUser> users) {
            mUsers.clear();
            mUsers.addAll(users);
