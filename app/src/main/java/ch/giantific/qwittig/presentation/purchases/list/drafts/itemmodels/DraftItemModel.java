 ...
 */
public class DraftItemModel extends BaseChildItemModel
        implements Comparable<DraftItemModel> {
    ...
    public DraftItemModel(@EventType int eventType,
    ...
    @Override
    public int compareTo(@NonNull DraftItemModel itemModel) {
    ...
    public boolean equals(Object o) {
        ...
        final DraftItemModel that = (DraftItemModel) o;
