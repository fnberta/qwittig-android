 ...
 */
public class CameraViewModelImpl extends ViewModelBaseImpl<CameraViewModel.ViewListener>
    ...
    public CameraViewModelImpl(@Nullable Bundle savedState,
    ...
    public void onPictureTaken(@NonNull byte[] data) {
        takenData = data;
        setImageTakenBarVisible(true);
    }

    @Override
    public void onFabCaptureClick(View v) {
        view.captureImage();
    }
    ...
    public void onDoneClick(View v) {
        ...
        getSubscriptions().add(view.createImageFile()
