 ...
 */
public class PurchaseItemModel extends BaseChildItemModel
        implements Comparable<PurchaseItemModel> {
    ...
    public PurchaseItemModel(@EventType int eventType,
    ...
    @Override
    public int compareTo(@NonNull PurchaseItemModel itemModel) {
    ...
    public boolean equals(Object o) {
        ...
        final PurchaseItemModel that = (PurchaseItemModel) o;
