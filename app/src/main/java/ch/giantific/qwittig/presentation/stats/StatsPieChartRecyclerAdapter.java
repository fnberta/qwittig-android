...
public class StatsPieChartRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        pieRow.setUsePercentageValues(mShowPercent);
    }
    ...
    private static class PieRow extends RecyclerView.ViewHolder {
         ...
         *
         * @param showPercentageValues whether to show percent values or not
         */
        public void setUsePercentageValues(boolean showPercentageValues) {
            mPieChart.setUsePercentValues(showPercentageValues);
        }
    }
}
