...
public class ChildEventSubscriber2<T extends ChildItemViewModel, S extends EmptyViewModel>
    ...
    public ChildEventSubscriber2(@NonNull SortedListView<T> sortedListView,
                                 @NonNull S viewModel,
