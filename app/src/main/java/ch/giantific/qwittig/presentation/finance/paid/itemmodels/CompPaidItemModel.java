 ...
 */
public class CompPaidItemModel extends BaseChildItemModel
        implements Comparable<CompPaidItemModel> {
    ...
    public CompPaidItemModel(@EventType int eventType,
    ...
    @Override
    public int compareTo(@NonNull CompPaidItemModel compPaidItemModel) {
        return date.compareTo(compPaidItemModel.getDate());
    }
    ...
    public boolean equals(Object o) {
        ...
        final CompPaidItemModel that = (CompPaidItemModel) o;
