 ...
 */
public class AddEditPurchaseItem extends BaseObservable implements AddEditPurchaseBaseItem {

    public static final Creator<AddEditPurchaseItem> CREATOR = new Creator<AddEditPurchaseItem>() {
        @Override
        public AddEditPurchaseItem createFromParcel(Parcel source) {
            return new AddEditPurchaseItem(source);
        }

        @Override
        public AddEditPurchaseItem[] newArray(int size) {
            return new AddEditPurchaseItem[size];
        }
    };
    ...
    public AddEditPurchaseItem(@NonNull String name, @NonNull String price,
                               @NonNull AddEditPurchaseItemUsersUser[] users) {
        mName = name;
        mPrice = price;
        mUsers = users;
    }

    private AddEditPurchaseItem(Parcel in) {
    ...
    public List<String> getSelectedIdentitiesIds() {
        ...
        for (AddEditPurchaseItemUsersUser user : mUsers) {
            if (user.isSelected()) {
