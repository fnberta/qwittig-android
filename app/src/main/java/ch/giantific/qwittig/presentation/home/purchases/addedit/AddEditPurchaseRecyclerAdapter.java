 ...
 */
public class AddEditPurchaseRecyclerAdapter extends RecyclerView.Adapter {

    private final AddEditPurchaseViewModel mViewModel;

    public AddEditPurchaseRecyclerAdapter(@NonNull AddEditPurchaseViewModel viewModel) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        final AddEditPurchaseBaseItem addEditItem = mViewModel.getItemAtPosition(position);
        ...
        switch (type) {
            case Type.HEADER: {
                ...
                final AddEditPurchaseHeaderItem headerRow = (AddEditPurchaseHeaderItem) addEditItem;
            ...
            case Type.USERS: {
                ...
                final AddEditPurchaseItemUsers itemUsersRow = (AddEditPurchaseItemUsers) addEditItem;
    ...
    private static class ItemUsersRow extends BindingRow<RowPurchaseAddItemUsersBinding> {
        ...
        private final AddEditPurchaseItemUsersRecyclerAdapter mRecyclerAdapter;
        private final List<AddEditPurchaseItemUsersUser> mUsers = new ArrayList<>();

        public ItemUsersRow(@NonNull Context context,
                            @NonNull RowPurchaseAddItemUsersBinding binding,
                            @NonNull AddEditPurchaseViewModel viewModel) {
            super(binding);
            ...
            mRecyclerAdapter = new AddEditPurchaseItemUsersRecyclerAdapter(viewModel, mUsers);
